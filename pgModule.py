# MODEULE FOR CREATING DATBASE CONNECTIONS AND OPERATIONS
#========================================================
...
import decimal # For handling decimal datatypes with extreme percision
...
class DatabaseOperation():
    """Crestes a connection to postgewSQL databese
    ...
    def getAllRowsFromTable(self, connectionArgs, table):
        ...
        try:
            ...
            if self.errorCode == 0:
                dbconnection.close()
    # TODO: Finish writting methods for
