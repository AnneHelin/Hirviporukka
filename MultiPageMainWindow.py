...
class MultiPageMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.statusBar.show() # Make is visible
        ...
        # TODO Try to set column wodths to fill the space available
    ...
    def alert(self, windowTitle, alertMsg, additionalMsg, details):
        ...
        # Add approriate title to the message box
        ...
        # Additional information about the error Finnish
        alertDialog.setInformativeText(additionalMsg)
        # Technical details in English (fron psycopg2)
    ...
    def saveShot(self):
        ...
        # Check for conversion errors    
            ...
            if errorOccurred == False:
                ...
                # Check if there is any db related errors (error handlig in ) 
